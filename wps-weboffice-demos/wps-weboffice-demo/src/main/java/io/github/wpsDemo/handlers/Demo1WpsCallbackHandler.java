 ...
 */
@Service
@WpsCallbackProvider(bizCode = BizCodeConstant.DEMO_1)
public class Demo1WpsCallbackHandler implements WpsCallbackService {

    @Override
    public WpsFileInfo fileInfo(WpsCallbackContext wpsCallbackContext) {
        System.out.println("====================fileInfo====================");
        System.out.println(BizCodeConstant.DEMO_1);
